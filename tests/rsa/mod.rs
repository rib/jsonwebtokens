...
#[test]
fn round_trip_sign_verification_certificate_pem_pkcs1() {
    let privkey_pem = include_bytes!("private_rsa_key_pkcs1.pem");
...
#[test]
fn round_trip_sign_verification_certificate_pem_pkcs8() {
    let privkey_pem = include_bytes!("private_rsa_key_pkcs8.pem");
    let certificate = include_bytes!("certificate_rsa_pkcs8.crt");
